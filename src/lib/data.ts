...
// export function getPostsByCategory(categorySlug: string): Blog[] {
//   return posts.filter((post) => post.slug === categorySlug);
// }
...
// export function getPopularPosts(): Blog[] {
//   return posts.filter((post) => post.popular);
// }

// export function getRecentPosts(count = 3): Blog[] {
//   return [...posts]
//     .sort(
